    ...
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
      ...
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">
          Effortlessly remove backgrounds with our AI-powered tool.{" "}Perfect for professionals and creators
          <br className="max-md:hidden" />
           who need fast, clean,{" "}
          {/* <br className="max-md:hidden" /> */}
          and ready-to-use images. Just upload your photo{" "}
          <br className="max-md:hidden" />
          and let our technology do the work.
        </p>
