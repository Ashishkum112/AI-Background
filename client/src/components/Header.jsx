    ...
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div >
            ...
            className='my-6 text-[15px] text-gray-500'>
                 Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas perferendis, minima obcaecati <br className='max-md:hidden'/>totam iste voluptatum officia non nam, doloremque facilis dolore eligendi aliquam cum amet. Accusamus autem dolore ea unde?</p>
            <div> 
                <input onChange={e => removeBg(e.target.files[0])} type="file" name="" accept='image/*' id="upload1" hidden />
